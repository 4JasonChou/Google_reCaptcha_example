package com.foyatech.zxing.ericssonlabs;

import com.foyatech.zxing.R;
import com.google.zxing.WriterException;
import com.foyatech.zxing.zxing.activity.CaptureActivity;
import com.foyatech.zxing.zxing.encoding.EncodingHandler;
...
public class BarCodeTestActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			String scanResult = bundle.getString("RESULT_QRCODE_STRING");
