package com.foyatech.zxing.zxing.activity;
...
import com.foyatech.zxing.R;
import com.google.zxing.BarcodeFormat;
import com.google.zxing.Result;
import com.foyatech.zxing.zxing.camera.CameraManager;
import com.foyatech.zxing.zxing.decoding.CaptureActivityHandler;
import com.foyatech.zxing.zxing.decoding.CaptureActivityHandler.DecodeCallback;
import com.foyatech.zxing.zxing.decoding.InactivityTimer;
...
public abstract class CaptureActivity extends Activity implements Callback, DecodeCallback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		/*此段 , 決定回傳資料的 key value */
		setResult(RESULT_OK, new Intent().putExtra("result", resultString));
		finish();
	}
